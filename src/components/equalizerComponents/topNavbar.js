  ...
  return (
    <SafeAreaView style={styles.container}>
      <Tab.Navigator
        ...
        <Tab.Screen name="Equalizer" component={EqualizerComponent} />
        <Tab.Screen name="Sound Effect" component={SoundEffectComponent} />
...
export default EqualizerTopBar;
